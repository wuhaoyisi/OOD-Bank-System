from .interfaces import BankingSystem
...
class BankingSystemImpl(BankingSystem):
    ...
    def merge_accounts(self, timestamp, account_id_1, account_id_2):
        ...
        self.balance_history[account_id_1] = sorted(self.balance_history[account_id_1])
        self.cashback_events.extend([(event[0], account_id_1, event[2]) for event in self.cashback_events if event[1] == account_id_2])
        for payment_id, payment_info in self.payments.items():
